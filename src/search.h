...
extern size_t EGexecute (void *, struct grepctx *, char const *, size_t, size_t *, char const *);

/* kwsearch.c */
extern void *Fcompile (char const *, size_t);
extern size_t Fexecute (void *, struct grepctx *, char const *, size_t, size_t *, char const *);

/* pcresearch.c */
extern void *Pcompile (char const *, size_t);
extern size_t Pexecute (void *, struct grepctx *, char const *, size_t, size_t *, char const *);
